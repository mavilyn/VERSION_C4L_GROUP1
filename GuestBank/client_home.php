	...
	<body>
		...
		<div id="body">
			...
			<div id="body_center">
				...
				<div id="panel_area_2">	
					...
					<div class="longpanel" id="editaccount">
						<img alt="" src="images/editaccount.png">
					</div>
				</div>
		...
		<div id="bottom_bottom">
				...
				$('#var').click(function() {
					...
					$('#name,#var, #transfer, #time, #email,#paybills,#editaccount').fadeOut('slow', function() {window.location = "viewaccountrecord_2.php";});
				});
				
				$('#email').click(function() {
				
					$('#name,#var, #transfer, #time, #email,#paybills,#editaccount').fadeOut('slow', function() {window.location = "email_2.php";});
				});
				
				$('#transfer').click(function() {
				
					$('#name,#var, #transfer, #time, #email,#paybills,#editaccount').fadeOut('slow', function() {window.location = "transfermoney.php";});
				});
				...
				$('#editaccount').click(function() {
					...
					$('#name,#var, #transfer, #time, #email,#paybills,#editaccount').fadeOut('slow', function() {window.location = "empty.php";});
				});
				
				$('#paybills').click(function() {
				
					$('#name,#var, #transfer, #time, #email,#paybills,#editaccount').fadeOut('slow', function() {window.location = "paybills.php";});
				});
				
				$('#logout_link').click(function() {
				
					$('#name,#var, #transfer, #time, #email,#paybills,#editaccount').fadeOut('slow', function() {window.location = "logout.php";});
				});
