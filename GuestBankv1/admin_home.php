	...
	<body>
		...
		<div id="body">
			...
			<div id="body_center">
				...
				<div id="panel_area_2">	
					...
					<div class="shortpanel" id="manageadmins">
						<img alt="" src="images/manageadmins_small.png">
					</div>
					
					<div class="shortpanel" id="aordaccounts">
						<img alt="" src="images/aordaccounts.png">
					</div>
					<?php } ?>
				</div>
		...
		<div id="bottom_bottom">
				...
				$('#billerrequests').click(function() {
					...
					$('#name,#billerrequests,#accountconnections,#time,#accountsettings,#modifybillerlist,#manageadmins,#aordaccounts').fadeOut('slow', function() {window.location = "billerrequests.php";});
				});
				
				$('#accountconnections').click(function() {
				
					$('#name,#billerrequests,#accountconnections,#time,#accountsettings,#modifybillerlist,#manageadmins,#aordaccounts').fadeOut('slow', function() {window.location = "account_connections.php";});
				});
				
				$('#accountsettings').click(function() {
				
					$('#name,#billerrequests,#accountconnections,#time,#accountsettings,#modifybillerlist,#manageadmins,#aordaccounts').fadeOut('slow', function() {window.location = "accountsettings.php";});
				});
				
				$('#modifybillerlist').click(function() {
				
					$('#name,#billerrequests,#accountconnections,#time,#accountsettings,#modifybillerlist,#manageadmins,#aordaccounts').fadeOut('slow', function() {window.location = "modify_billerlist.php";});
				});
				
				$('#manageadmins').click(function() {
				
					$('#name,#billerrequests,#accountconnections,#time,#accountsettings,#modifybillerlist,#manageadmins,#aordaccounts').fadeOut('slow', function() {window.location = "manage_admins.php";});
				});
				
				$('#aordaccounts').click(function() {
				
					$('#name,#billerrequests,#accountconnections,#time,#accountsettings,#modifybillerlist,#manageadmins,#aordaccounts').fadeOut('slow', function() {window.location = "aordaccounts.php";});
				});
				
				$('#logout_link').click(function() {
				
					$('#name,#billerrequests,#accountconnections,#time,#accountsettings,#modifybillerlist,#manageadmins,#aordaccounts').fadeOut('slow', function() {window.location = "logout_2.php";});
				});
