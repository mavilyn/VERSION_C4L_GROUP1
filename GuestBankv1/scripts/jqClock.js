      ...
      if(myoptions=="destroy"){ clearTimeout(t[el_id]); }
        ...
        if(myoptions.calendar!="false") {
          if (myoptions.langSet=="en") {
            calend = "<span class='clockdate'>"+locale[myoptions.langSet].weekdays[dy]+',<br /> '+locale[myoptions.langSet].months[mo]+' '+dt+"</span>";
          }
          else {
            calend = "<span class='clockdate'>"+locale[myoptions.langSet].weekdays[dy]+',<br /> '+dt+' '+locale[myoptions.langSet].months[mo]+"</span>";
          }
        }
        $(el).html(calend+"<span class='clocktime'>"+h+":"+m+"<span class='ap'>"+ap+"</span></span>");
