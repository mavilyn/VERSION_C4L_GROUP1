...
<body>-->
			<?php
				...
				$query = 'select c.billername, b.servicenum, b.refnum, b.amountdue, b.dateissued from current_biller c, bills b where c.accountnum = :accountnum and b.biller_accountnum = c.billeraccountnum and b.refnum = c.refnum';
